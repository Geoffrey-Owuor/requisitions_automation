...
const DashboardAlert = () => {
  ...
  return (
    <ClientPortal>
      <div
        className={`fixed top-2 -right-47 z-100 hidden items-center gap-3 rounded-full bg-neutral-900 px-5 py-3 text-white shadow-2xl sm:flex ${isExiting ? "animate-slide-out-top" : "animate-slide-in-top"} `}
      >
