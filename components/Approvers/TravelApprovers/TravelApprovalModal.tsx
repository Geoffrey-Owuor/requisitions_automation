  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden p-5">
      <div className="relative z-10 mx-auto max-w-225">
        {/* Banner image */}
        <div className="mb-6 h-35 overflow-hidden rounded-2xl shadow-[0_8px_32px_rgba(160,60,60,0.12)]">
          <Image
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-[14px] text-[#7c5a5a]">
            Submitted {dateFormatter(requestCreatedAt)} · Pending your approval
          </p>
        </div>
        ...
        <div className="rounded-3xl border border-gray-100 bg-white/65 p-10 shadow-[0_24px_48px_rgba(160,60,60,0.10)] backdrop-blur-2xl">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              type="button"
              onClick={() => {
                // TODO: wire up decline logic — commentsPayload available
                console.log("Decline", commentsPayload);
              }}
            ...
            <button
              type="button"
              onClick={() => {
                // TODO: wire up approve logic — commentsPayload available
                console.log("Approve", commentsPayload);
              }}
